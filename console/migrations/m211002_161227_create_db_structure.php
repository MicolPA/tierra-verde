...
class m211002_161227_create_db_structure extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{%tourist_packages}}', [
            ...
            'image_5' => $this->string(),
            'image_6' => $this->string(),
            'kids_age_min' => $this->integer()->notNull(),
            'kids_age_max' => $this->integer()->notNull(),
            'max_people' => $this->integer()->notNull(),
        ...
        $this->createTable('{{%tourist_packages_payments}}', [
            ...
            'adults_amount' => $this->float()->notNull(),
            'kids_amount' => $this->float()->notNull(),
